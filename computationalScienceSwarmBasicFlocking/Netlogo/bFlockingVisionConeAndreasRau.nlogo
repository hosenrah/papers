...
to go
  ...
  [
    if visualize-vision[
      if glubsh[
        set flockmates-outter other fishes in-cone vision vision-angle-outter
        set flockmates-inner other fishes in-cone vision vision-angle-inner
  
        set flockmates (flockmates-outter with [ not member? self [flockmates-inner] of myself])
    
        ask flockmates[ set color green ]
      ]
      if not glubsh[
        ask other fishes in-cone vision vision-angle-outter[ set color green ]
      ]
    ]
    flock
  ]
...
to find-flockmates  ;; turtle procedure
  ...
  if not glubsh
  [
    set flockmates other fishes in-cone vision vision-angle-outter
  ]
end
